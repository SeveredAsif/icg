// Generated from C2105131Lexer.g4 by ANTLR 4.13.2
...
public class C2105131Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LINE_COMMENT", "BLOCK_COMMENT", "STRING", "WS", "IF", "CASE", "SWITCH", 
			"IN", "TO", "ELSE", "FOR", "FOREACH", "FORIN", "DO", "WHILE", "TIMES", 
			"PRINTLN", "RETURN", "INT", "FLOAT", "VOID", "BREAK", "CONTINUE", "GOTO", 
			"COLON", "QMARK", "LPAREN", "RPAREN", "LCURL", "RCURL", "LTHIRD", "RTHIRD", 
	...
	public C2105131Lexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "C2105131Lexer.g4"; }
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 24:
			...
			break;
		case 25:
			QMARK_action((RuleContext)_localctx, actionIndex);
			break;
		case 26:
	...
	private void CASE_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 4:
			 writeIntoLexLogFile("Line# " + getLine() + ": Token <CASE> Lexeme " + getText()); 
			break;
		}
	}
	private void SWITCH_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 5:
			 writeIntoLexLogFile("Line# " + getLine() + ": Token <SWITCH> Lexeme " + getText()); 
			break;
		}
	}
	private void IN_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 6:
			 writeIntoLexLogFile("Line# " + getLine() + ": Token <IN> Lexeme " + getText()); 
			break;
		}
	}
	private void TO_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 7:
			 writeIntoLexLogFile("Line# " + getLine() + ": Token <TO> Lexeme " + getText()); 
			break;
		}
	}
	...
	private void FOREACH_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 10:
			 writeIntoLexLogFile("Line# " + getLine() + ": Token <FOREACH> Lexeme " + getText()); 
			break;
		}
	}
	private void FORIN_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 11:
			 writeIntoLexLogFile("Line# " + getLine() + ": Token <FORIN> Lexeme " + getText()); 
			break;
		}
	}
	private void DO_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 12:
			writeIntoLexLogFile("Line# " + getLine() + ": Token <DO> Lexeme " + getText());
			break;
		}
	}
	...
	private void TIMES_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 14:
			 writeIntoLexLogFile("Line# " + getLine() + ": Token <TIMES> Lexeme " + getText()); 
			break;
		}
	}
	...
	private void CONTINUE_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 21:
			writeIntoLexLogFile("Line# " + getLine() + ": Token <CONTINUE> Lexeme " + getText()); 
			break;
		}
	}
	private void GOTO_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 22:
			writeIntoLexLogFile("Line# " + getLine() + ": Token <GOTO> Lexeme " + getText());
			break;
		}
	}
	private void COLON_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 23:
			writeIntoLexLogFile("Line# " + getLine() + ": Token <COLON> Lexeme " + getText());
			break;
		}
	}
	private void QMARK_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 24:
			writeIntoLexLogFile("Line# " + getLine() + ": Token <QMARK> Lexeme " + getText());
			break;
		}
	}
